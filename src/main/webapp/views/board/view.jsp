...
<section>
    ...
    <div class="bg-img-start" style="background-image: url(<%=path%>/views/css/img/card-11.svg);">
        ...
        <h1 class="text-center mb-5">자유게시판</h1>
            <!-- Card -->
            <div class="card card-lg">
                <div class="card-body">
					...
					%>
					<button type="button" class="btn btn-sm btn-primary" onclick="location.href='<%= request.getContextPath() %>/board/update?boardNo=<%=board.getNo()%>'">수정</button>
					<button type="button" class="btn btn-sm btn-primary" id="btnDelete">삭제</button>
					<%}}%>
					<button type="button" class="btn btn-sm btn-primary" onclick="location.href='<%= request.getContextPath() %>/board/list'">목록</button>
            </div>
